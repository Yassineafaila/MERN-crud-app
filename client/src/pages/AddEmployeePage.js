...
import { createEmployee, ValidateForm } from "../services/adminApi";
      ...
      >
        ...
        <div className="form-group flex  gap-4 my-11">
          <Button
            type="submit"
            value="Add"
            className="text-white bg-blue-600 uppercase font-semibold px-4 w-28 rounded-md py-3  hover:bg-opacity-100 text-md md:text-sm"
          />
          <Button
            type="button"
            value="Cancel"
